    ...
    return (
        <Card className='post mt-4 mb-5 mx-3 shadow'>
            ...
            <Card.Footer className='cartFooter d-flex align-items-center justify-content-between w-100 position-relative border-bottom'>
                {
                    isLiked && !isdisLiked ? <i onClick={likeHandler} className="cartIcon reactedIcon cartIconOne fa-solid fa-heart position-absolute"></i> : <i onClick={likeHandler} className="cartIcon cartIconOne fa-regular fa-heart position-absolute"></i>
                }
                {
                    isdisLiked && !isLiked ? <i onClick={disLikeHandler} className="cartIcon reactedIcon cartIconTwo fa-solid fa-thumbs-down position-absolute"></i> : <i onClick={likeHandler} className="cartIcon cartIconTwo fa-regular fa-thumbs-down position-absolute"></i>
                }
                ...
                <i onClick={() => { setshowCommentBox(!showCommentBox); setIsLiked(false) }} className="cartIcon cartIconThree fa-regular fa-comment position-absolute "></i>
            </Card.Footer>
            {
                showCommentBox &&
                <Form>
                    ...
                    <div className='d-flex justify-content-end'>
                        <Button className='homeCommentBtn me-2 mb-2' type="submit" value="Submit">Comment</Button>
                    </div>
                </Form>
            }
        </Card>
